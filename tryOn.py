...
def detectUpperBody(image):
    cascadePath = "C:\\Users\\DELL\\OneDrive\\Desktop\\Trail-Room-master\\Project\\data\\haarcascade_upperbody.xml"
    result = image.copy()
...
def cvloop(run_event):
    ...
    while run_event.is_set(): 
        ...
        for face in faces: 
            ...
            if SPRITES[5]:
                findRects = []
                upperPath = "C:\\Users\\DELL\\OneDrive\\Desktop\\Trail-Room-master\\Project\\data\\haarcascade_upperbody.xml"
                imageGray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
...
if len(sys.argv) < 2:
    print("Usage: python tryOn.py path_to_image.jpg")
    sys.exit(1)
